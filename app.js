  ...
  if (!aircraft) {
    ...
    try { 
      if (typeof gerarPreOrcamento === 'function') {
        if (typeof window.safeScheduleRecalc === "function") window.safeScheduleRecalc(gerarPreOrcamento);
...
function bindAircraftParamsUI() {
  ...
  function applyFor(name) {
    ...
    try { if (typeof window.safeScheduleRecalc === "function") window.safeScheduleRecalc(gerarPreOrcamento); } catch (e) {}
  }
...
function loadDraft(){
  try {
    ...
    try { if (typeof window.safeScheduleRecalc === "function") window.safeScheduleRecalc(gerarPreOrcamento); } catch {}
    return payload;
  } catch(e){ return null; }
}
  ...
  const script = `
    <script>(function(){
      ...
      root.addEventListener('change',e=>{ if(e.target && e.target.matches('input[data-inline-pdf-toggle]')){ 
        ...
        if(typeof window.safeScheduleRecalc === "function") { window.safeScheduleRecalc(window.gerarPreOrcamento); }
      }});
    })();</script>`;
...
if (typeof document !== 'undefined') {
  document.addEventListener('DOMContentLoaded', () => {
    try {
      ...
      const trigger = () => { try { if (typeof window.safeScheduleRecalc === "function") window.safeScheduleRecalc(gerarPreOrcamento); } catch (e) {} };
...
if (typeof document !== 'undefined') {
  ...
  if (aeronaveSel && tarifaInput) {
    ...
    tarifaInput.addEventListener('input', () => {
      ...
      try { if (typeof window.safeScheduleRecalc === "function") window.safeScheduleRecalc(gerarPreOrcamento); } catch (e) { /* ignore */ }
    });
