...
async function gerarPDF(stateIgnored, methodSelectionIgnored = null) {
  ...
  const docDefinition = App.pdf.buildDocDefinition(snapshot, selectedMethod === 'time' ? 'method2' : 'method1', pdfOptions);
  try {
...
if (typeof module !== 'undefined') {
  module.exports = { buildState, gerarPDF, calcularComissao, calcTempo, saveDraft, loadDraft, adjustLegTime, getSelectedPdfMethod };
 }
